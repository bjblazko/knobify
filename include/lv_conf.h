...
/*Off: the project ships its own Montserrat-derived fonts with Latin-1/Latin
 *Extended-A coverage instead of these ASCII-only builds. See
 *lib/ui-widgets/TextFont.h.*/
...
#define LV_FONT_CUSTOM_DECLARE   LV_FONT_DECLARE(knobify_text_font_14) LV_FONT_DECLARE(knobify_text_font_16) LV_FONT_DECLARE(knobify_text_font_20) LV_FONT_DECLARE(knobify_text_font_28)

/*Always set a default font*/
#define LV_FONT_DEFAULT &knobify_text_font_16
