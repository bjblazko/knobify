 ...
 *
 * `.fallback = &knobify_text_font_14` below lets the pill mix these
 ...
 * two short-and-wide glyphs) to knobify_text_font_14's values (16 / 3).
 ...
 * them. This font is always the pill's primary font (knobify_text_font_14
 ...
 * .line_height/.base_line if this font (or knobify_text_font_14) is ever
 * regenerated.
 *
...
lv_font_t knobify_icon_font_16 = {
    ...
    // Hand-set to knobify_text_font_14's own line_height/base_line (not
    ...
    // always primary over the knobify_text_font_14 fallback. See header
    // comment.
