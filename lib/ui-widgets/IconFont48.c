 ...
 * Size: 48 px
 * Bpp: 4
 * Opts: --font MaterialSymbolsOutlined.ttf --range 0xE405,0xE8B8,0xE518,0xEF44 --size 48 --bpp 4 --no-compress --format lvgl --lv-include lvgl.h --lv-font-name knobify_icon_font_48 -o IconFont48.c
 *
 ...
 * Brightness screen (ADR 0010) and the Sleep screen (ADR 0015).
 *
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 2240, .adv_w = 768, .box_w = 40, .box_h = 40, .ofs_x = 4, .ofs_y = 4}
};
